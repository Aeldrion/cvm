...
# Generates an underground nether portal

# Set a random height
scoreboard players set @s aestd.random.min 17
scoreboard players set @s aestd.random.max 38
...
execute at @s run setblock ~ ~ ~ minecraft:structure_block{mode:"LOAD",name:"cvm:nether_portal",posX:-4,posY:0,posZ:-4}
