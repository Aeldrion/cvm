...
# Generates a jungle shrine

# Set a random height
scoreboard players set @s aestd.random.min 20
scoreboard players set @s aestd.random.max 40
...
execute at @s run setblock ~ ~ ~ minecraft:structure_block{mode:"LOAD",name:"cvm:jungle_shrine",posX:-4,posY:0,posZ:-4}
