...
# Checks if the book is in the correct slot
...
execute if score @s aestd.var matches 1 unless score @s cvm.blsgs.slot = #cvm cvm.blsgs.slot run function cvm:block/blessing_altar/behavior/curse
execute if score @s aestd.var matches 1 if score @s cvm.blsgs.slot = #cvm cvm.blsgs.slot run function cvm:block/blessing_altar/behavior/bless_book
